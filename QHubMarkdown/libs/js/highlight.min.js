 ...
 */
  var hljs=function(){"use strict";var e={exports:{}};function n(e){
    ...
    }),e.children.length>0&&(d.ignoreUnescapedHTML||(console.log("One of your code blocks includes unescaped HTML. This is a potentially serious security risk."),
    console.log("https://github.com/highlightjs/highlight.js/wiki/security"),
    // I changed .warn to .log (the three closest console logs). https://github.com/davidleonstr
    console.log("The element with unescaped HTML:"),
    console.log(e)),d.throwUnescapedHTML))throw new V("One of your code blocks includes unescaped HTML.",e.innerHTML)
